...
def read_images(path, classes, img_height = 128, img_width = 128, img_channels = 3,shuffle=False):
    ...
    #shuffle the whole images set, every batch could contain cat and dogs
    if(shuffle==True):
